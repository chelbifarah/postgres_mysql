...
if __name__ == '__main__':
    ...
    try:
        ...
        if choix == '1':
            valeur_colonnes = f_mysql.mysql_connect_engine(user_name, password_user, host_name, port_mysql, db_name,
                                                           sql_query)
            print("les colonnes sont: ")
            print(valeur_colonnes)
        elif choix == '2':
            valeur_colonnes = f_postgres.postgres_connect_engine(user_name, password_user, host_name, port_postgres,
                                                                 db_name, sql_query)
            print("les colonnes sont: ")
            print(valeur_colonnes)
        else:
        ...
        #utiliser lower et strip sur les colonnes de la base de données
        db_col_lower = db_columns_lower(valeur_colonnes)
        #print("les colonnes en lower ")
        #print(db_col_lower)


        # verifier si les colonnes du fichier existent dans la base! si non on les ajoute
        for i in range(n):
            verifier_existance_colonne(header_tuple[i], db_col_lower)
